...
- Phase 8 planning is recorded in `docs/phase-8-pwa-manifest-readiness-goal-mode-execution-guide.md`; the next slice is manifest-first PWA readiness with local icons and smoke checks, while service-worker/offline behavior remains deferred.
